...
void setup_dvo2tft(void)
{
    ...
    BF_WR(LCD3_REG4C, UNK15, 0);
    BF_WR(LCD3_REG4C, UNK12_8, 0);
    BF_WR(LCD3_REG4C, UNK19_16, 0);
    BF_WR(LCD3_REG4C, UNK14, 1);
    BF_WR(LCD3_REG4C, UNK7_0, 8);
    BF_WR(LCD3_REG4C, UNK20, 0);
    BF_WR(LCD3_REG4C, UNK23, 0);
    BF_WR(LCD3_REG4C, UNK22, 0);
    ...
    BF_WR(UNK_REG0, UNK21_19, 2);
    BF_WR(UNK_REG80, WIDTH, LCD_WIDTH / 16);
    BF_WR(UNK_REG80, HEIGHT, LCD_HEIGHT / 16);
    BF_WR(UNK_REG0, UNK18_0, 0x4e000);
    BF_WR(UNK_REG0, UNK22, 0);
    BF_WR(UNK_REG0, UNK24_23, 1);
    BF_WR(UNK_REG0, UNK26_25, 1);

    HW_LCD3_REG30 = 0x821;

    lcd_power_on();

    BF_WR_V(LCD3_REG80, MAGIC, MAGIC);
    //unknown03(1);
}
#endif
